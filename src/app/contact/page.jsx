        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a 
              ...
              className="glass p-8 rounded-3xl border border-white/20 dark:border-white/10 space-y-4 hover:border-indigo-500/40 transition-colors"
            >
              ...
              <span className="text-sm font-black text-indigo-600">support@revoxera.com</span>
            </a>
            ...
            >
              ...
              <span className="text-sm font-black text-indigo-600">github.com/revoxera</span>
            </a>
          </div>
        </section>
      </main>
