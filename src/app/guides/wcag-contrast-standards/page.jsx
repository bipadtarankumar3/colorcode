      ...
      <main className="w-full max-w-4xl mx-auto px-6 py-12 flex-grow space-y-8">
        ...
        <article className="space-y-6">
          ...
          <div className="glass p-8 rounded-3xl border border-white/20 dark:border-white/10 space-y-6 leading-relaxed">
            <h2 className="text-xl font-bold uppercase text-indigo-600">Why Color Contrast Matters</h2>
            <p>
            ...
            <h2 className="text-xl font-bold uppercase text-indigo-600">Compliance Levels: AA vs AAA</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-5 rounded-2xl bg-white/40 border border-white/30 dark:bg-slate-800/40 space-y-2">
                <h3 className="font-extrabold text-sm text-indigo-700 dark:text-indigo-400 uppercase">Level AA (Standard)</h3>
              ...
              <div className="p-5 rounded-2xl bg-white/40 border border-white/30 dark:bg-slate-800/40 space-y-2">
                <h3 className="font-extrabold text-sm text-indigo-700 dark:text-indigo-400 uppercase">Level AAA (Enhanced)</h3>
                <p className="text-xs opacity-75">
            ...
            <h2 className="text-xl font-bold uppercase text-indigo-600">Exceptions to the Rules</h2>
            <p>
            ...
            <h2 className="text-xl font-bold uppercase text-indigo-600">How to Fix Contrast Issues</h2>
            <p>
            ...
            <div className="pt-6 border-t border-black/5 flex flex-col items-center">
              <Link 
                ...
                className="px-6 py-3.5 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white font-black text-xs tracking-widest uppercase transition-all shadow-[0_10px_20px_rgba(79,70,229,0.3)] hover:-translate-y-0.5"
              >
